        ...
        <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className={`block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 outline-gray-300 ${formErrors.username ? "border border-red-500" : ""}`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 outline-gray-300 ${formErrors.password ? "border border-red-500" : ""}`}
            />
